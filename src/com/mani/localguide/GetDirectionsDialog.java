...
public class GetDirectionsDialog extends Dialog {
	...
	public static Typeface getTypeface(Context context, String typeface) {
		...
		public void getDirections() {
			...
			else
			{
				...
				{
		    		new ErrorDialog(mContext,mContext.getString(R.string.no_location_entered),mContext.getString(R.string.pls_enter_location),false).show();
				}
			}
